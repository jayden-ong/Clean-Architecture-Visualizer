...
export class CreateModuleUseCaseController {
    constructor(private readonly inputBoundary: CreateModuleUseCaseInputBoundary) {}

    async execute(feature : string, usecase : string) : Promise<void> {
        const createModuleUseCaseInputData = new CreateModuleUseCaseInputData(feature, usecase);
